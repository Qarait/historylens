...
![Version](https://img.shields.io/badge/version-1.11.0-16a085.svg)
...
* **Realtime streaming engine (v1.1.0)**: watch the analysis type out piece by piece. The "Hook" and "Era" appear instantly, followed by regional cards as the AI completes them.
...
* **Perspective Mode**: reframe completed results through political, social, economic, cultural, and source-critical lenses while showing the evidence used, missing evidence, and the limits of each interpretation
...
HistoryLens is preconfigured to use a secure backend proxy (`/api/history`). You do **not** need to add your API key to the client side JavaScript.
...
│   ├── perspective-mode.js # Evidence-aware interpretive lenses
...
* [x] Adaptive region lists based on historical relevance
* [x] Decade and custom-period views
