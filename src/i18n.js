(function initHistoryLensI18n(global) {
  ...
  const dictionary = {
    en: {
      ...
      'map.eventsAcrossSpace': 'Events Across Space',
      'map.changeAcrossSpace': 'Change Across Space',
      'map.geographyExplorer': 'Historical geography explorer',
      'map.compareExplorer': '{label} explorer',
      'map.guidance.year': 'Select a region marker or a relationship arc to investigate the year spatially.',
      'map.guidance.period': 'Select a region marker or a relationship arc to investigate the period spatially.',
      'map.eventLayer': 'Event layer',
      'map.turningPointLayer': 'Turning-point layer',
      'map.primary': 'Primary',
      'map.supporting': 'Supporting {index}',
      'map.event': 'Event {index}',
      'map.definingShift': 'Defining shift',
      'map.supportingShift': 'Supporting shift',
      'map.exploreRegions': 'Explore regions',
      'map.regionPosition': 'Region {index} of {total}',
      'map.relationshipPosition': 'Relationship {index} of {total}',
      'map.crossRegionConnection': 'Cross-region connection',
      'map.regionalContext': 'Regional context',
      'map.regionalAnalysis': 'Regional analysis',
      'map.relationshipFallback': 'These regions were linked by the wider historical system.',
      'map.relationshipPattern': 'Wider pattern',
      'map.regionalPattern': 'Regional pattern',
      'map.whyItMatters': 'Why it matters',
      'map.previous': '← Previous',
      'map.next': 'Next →',
      'map.openRegionalAnalysis': 'Open full regional analysis',
      'map.pending': 'Map data will appear as regional analysis completes.',
      'map.legend.markers': 'Numbered markers are regional events',
      'map.legend.arcs': 'Arcs reveal cross-region relationships',
      'map.legend.geography': 'Geography is contextual, not a border reconstruction',
      'map.aria': '{label} interactive historical geography map',
      'map.relationshipAria': 'Relationship: {from} and {to}',
      'regionProfile.label.ancient': 'Ancient world regions',
      'regionProfile.label.medieval': 'Medieval world regions',
      'regionProfile.label.early-modern': 'Early modern world regions',
      'regionProfile.label.modern': 'Modern continental regions',
      'regionProfile.ancient.region.mediterranean.label': 'Mediterranean & Europe',
      'regionProfile.ancient.region.mediterranean.sub': 'Rome, Greece, and neighboring societies',
      'regionProfile.ancient.region.west_south_asia.label': 'West, Central & South Asia',
      'regionProfile.ancient.region.west_south_asia.sub': 'Persia, Mesopotamia, the steppe, and India',
      'regionProfile.ancient.region.east_asia.label': 'East Asia',
      'regionProfile.ancient.region.east_asia.sub': 'China, Korea, Japan, and adjacent societies',
      'regionProfile.ancient.region.africa.label': 'Africa',
      'regionProfile.ancient.region.africa.sub': 'North, West, East, Central, and Southern Africa',
      'regionProfile.ancient.region.americas_pacific.label': 'Americas & Pacific',
      'regionProfile.ancient.region.americas_pacific.sub': 'American civilizations and Pacific societies',
      'regionProfile.medieval.region.europe_mediterranean.label': 'Europe & Mediterranean',
      'regionProfile.medieval.region.europe_mediterranean.sub': 'Latin, Byzantine, and neighboring worlds',
      'regionProfile.medieval.region.islamic_world.label': 'Islamic World & Central Asia',
      'regionProfile.medieval.region.islamic_world.sub': 'Middle East, North Africa, Persia, and the steppe',
      'regionProfile.medieval.region.south_east_asia.label': 'South & East Asia',
      'regionProfile.medieval.region.south_east_asia.sub': 'India, China, Korea, Japan, and Southeast Asia',
      'regionProfile.medieval.region.africa.label': 'Sub-Saharan Africa',
      'regionProfile.medieval.region.africa.sub': 'West, East, Central, and Southern Africa',
      'regionProfile.medieval.region.americas_pacific.label': 'Americas & Pacific',
      'regionProfile.medieval.region.americas_pacific.sub': 'American civilizations and Pacific societies',
      'regionProfile.early-modern.region.europe.label': 'Europe',
      'regionProfile.early-modern.region.europe.sub': 'Atlantic, Mediterranean, and Eastern Europe',
      'regionProfile.early-modern.region.middle_south_asia.label': 'Middle East & South Asia',
      'regionProfile.early-modern.region.middle_south_asia.sub': 'Ottoman, Persian, Central Asian, and Indian worlds',
      'regionProfile.early-modern.region.east_asia_pacific.label': 'East Asia & Pacific',
      'regionProfile.early-modern.region.east_asia_pacific.sub': 'China, Japan, Korea, Southeast Asia, and Oceania',
      'regionProfile.early-modern.region.africa.label': 'Africa',
      'regionProfile.early-modern.region.africa.sub': 'North, West, East, Central, and Southern Africa',
      'regionProfile.early-modern.region.americas.label': 'The Americas',
      'regionProfile.early-modern.region.americas.sub': 'Indigenous, colonial, and revolutionary societies',
      'regionProfile.modern.region.europe.label': 'Europe',
      'regionProfile.modern.region.europe.sub': 'Western & Eastern Europe',
      'regionProfile.modern.region.asia.label': 'Asia',
      'regionProfile.modern.region.asia.sub': 'East, South, Central Asia & Middle East',
      'regionProfile.modern.region.namerica.label': 'The Americas',
      'regionProfile.modern.region.namerica.sub': 'North, Central & South America',
      'regionProfile.modern.region.africa.label': 'Africa',
      'regionProfile.modern.region.africa.sub': 'Sub-Saharan & North Africa',
    ...
    ru: {
      ...
      'map.eventsAcrossSpace': 'События в пространстве',
      'map.changeAcrossSpace': 'Изменения в пространстве',
      'map.geographyExplorer': 'Историко-географическая карта',
      'map.compareExplorer': 'Карта {label}',
      'map.guidance.year': 'Выберите региональный маркер или дугу связи, чтобы увидеть год пространственно.',
      'map.guidance.period': 'Выберите региональный маркер или дугу связи, чтобы увидеть период пространственно.',
      'map.eventLayer': 'Слой событий',
      'map.turningPointLayer': 'Слой поворотных точек',
      'map.primary': 'Главное',
      'map.supporting': 'Дополнительно {index}',
      'map.event': 'Событие {index}',
      'map.definingShift': 'Определяющий сдвиг',
      'map.supportingShift': 'Дополнительный сдвиг',
      'map.exploreRegions': 'Регионы',
      'map.regionPosition': 'Регион {index} из {total}',
      'map.relationshipPosition': 'Связь {index} из {total}',
      'map.crossRegionConnection': 'Межрегиональная связь',
      'map.regionalContext': 'Региональный контекст',
      'map.regionalAnalysis': 'Региональный анализ',
      'map.relationshipFallback': 'Эти регионы были связаны более широкой исторической системой.',
      'map.relationshipPattern': 'Широкая закономерность',
      'map.regionalPattern': 'Региональная закономерность',
      'map.whyItMatters': 'Почему это важно',
      'map.previous': '← Назад',
      'map.next': 'Далее →',
      'map.openRegionalAnalysis': 'Открыть полный региональный анализ',
      'map.pending': 'Данные карты появятся после завершения регионального анализа.',
      'map.legend.markers': 'Нумерованные маркеры показывают региональные события',
      'map.legend.arcs': 'Дуги показывают связи между регионами',
      'map.legend.geography': 'География служит контекстом, а не реконструкцией границ',
      'map.aria': 'Интерактивная историко-географическая карта: {label}',
      'map.relationshipAria': 'Связь: {from} и {to}',
      'regionProfile.label.ancient': 'Регионы древнего мира',
      'regionProfile.label.medieval': 'Регионы средневекового мира',
      'regionProfile.label.early-modern': 'Регионы раннего Нового времени',
      'regionProfile.label.modern': 'Современные континентальные регионы',
      'regionProfile.ancient.region.mediterranean.label': 'Средиземноморье и Европа',
      'regionProfile.ancient.region.mediterranean.sub': 'Рим, Греция и соседние общества',
      'regionProfile.ancient.region.west_south_asia.label': 'Западная, Центральная и Южная Азия',
      'regionProfile.ancient.region.west_south_asia.sub': 'Персия, Месопотамия, степь и Индия',
      'regionProfile.ancient.region.east_asia.label': 'Восточная Азия',
      'regionProfile.ancient.region.east_asia.sub': 'Китай, Корея, Япония и соседние общества',
      'regionProfile.ancient.region.africa.label': 'Африка',
      'regionProfile.ancient.region.africa.sub': 'Северная, Западная, Восточная, Центральная и Южная Африка',
      'regionProfile.ancient.region.americas_pacific.label': 'Америки и Тихий океан',
      'regionProfile.ancient.region.americas_pacific.sub': 'Американские цивилизации и общества Тихого океана',
      'regionProfile.medieval.region.europe_mediterranean.label': 'Европа и Средиземноморье',
      'regionProfile.medieval.region.europe_mediterranean.sub': 'Латинский, византийский и соседние миры',
      'regionProfile.medieval.region.islamic_world.label': 'Исламский мир и Центральная Азия',
      'regionProfile.medieval.region.islamic_world.sub': 'Ближний Восток, Северная Африка, Персия и степь',
      'regionProfile.medieval.region.south_east_asia.label': 'Южная и Восточная Азия',
      'regionProfile.medieval.region.south_east_asia.sub': 'Индия, Китай, Корея, Япония и Юго-Восточная Азия',
      'regionProfile.medieval.region.africa.label': 'Африка к югу от Сахары',
      'regionProfile.medieval.region.africa.sub': 'Западная, Восточная, Центральная и Южная Африка',
      'regionProfile.medieval.region.americas_pacific.label': 'Америки и Тихий океан',
      'regionProfile.medieval.region.americas_pacific.sub': 'Американские цивилизации и общества Тихого океана',
      'regionProfile.early-modern.region.europe.label': 'Европа',
      'regionProfile.early-modern.region.europe.sub': 'Атлантическая, средиземноморская и Восточная Европа',
      'regionProfile.early-modern.region.middle_south_asia.label': 'Ближний Восток и Южная Азия',
      'regionProfile.early-modern.region.middle_south_asia.sub': 'Османский, персидский, центральноазиатский и индийский миры',
      'regionProfile.early-modern.region.east_asia_pacific.label': 'Восточная Азия и Тихий океан',
      'regionProfile.early-modern.region.east_asia_pacific.sub': 'Китай, Япония, Корея, Юго-Восточная Азия и Океания',
      'regionProfile.early-modern.region.africa.label': 'Африка',
      'regionProfile.early-modern.region.africa.sub': 'Северная, Западная, Восточная, Центральная и Южная Африка',
      'regionProfile.early-modern.region.americas.label': 'Америки',
      'regionProfile.early-modern.region.americas.sub': 'Коренные, колониальные и революционные общества',
      'regionProfile.modern.region.europe.label': 'Европа',
      'regionProfile.modern.region.europe.sub': 'Западная и Восточная Европа',
      'regionProfile.modern.region.asia.label': 'Азия',
      'regionProfile.modern.region.asia.sub': 'Восточная, Южная, Центральная Азия и Ближний Восток',
      'regionProfile.modern.region.namerica.label': 'Америки',
      'regionProfile.modern.region.namerica.sub': 'Северная, Центральная и Южная Америка',
      'regionProfile.modern.region.africa.label': 'Африка',
      'regionProfile.modern.region.africa.sub': 'Африка к югу от Сахары и Северная Африка',
  ...
  function localizedOrFallback(key, fallback, params = {}) {
    const value = t(key, params);
    return value === key ? fallback : value;
  }

  function localizedProfileLabel(profile) {
    if (!profile?.id) return profile?.label || '';
    return localizedOrFallback(`regionProfile.label.${profile.id}`, profile.label || profile.id);
  }

  function localizedRegionLabel(region, profile) {
    if (!region?.id) return region?.label || '';
    const scoped = profile?.id ? `regionProfile.${profile.id}.region.${region.id}.label` : '';
    return scoped ? localizedOrFallback(scoped, region.label || region.id) : (region.label || region.id);
  }

  function localizedRegionSub(region, profile) {
    if (!region?.id) return region?.sub || '';
    const scoped = profile?.id ? `regionProfile.${profile.id}.region.${region.id}.sub` : '';
    return scoped ? localizedOrFallback(scoped, region.sub || '') : (region.sub || '');
  }

  function localizedRegionProfile(profile) {
    if (!profile) return profile;
    return {
      ...profile,
      label: localizedProfileLabel(profile),
      regions: (profile.regions || []).map(region => ({
        ...region,
        label: localizedRegionLabel(region, profile),
        sub: localizedRegionSub(region, profile),
      })),
    };
  }
